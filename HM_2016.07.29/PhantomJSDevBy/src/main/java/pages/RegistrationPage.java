...
import helper.HelperRandomClass;
...
public class RegistrationPage {
    ...
    public static final By UPLOAD_BUTTON = Locators.get("UploadButton");
    public static final By CHOOSE_MALE = Locators.get("ChooseMale");
    ...
    public static void PopulateRegistryForm(WebDriver driver) {
        ...
        driver.findElement(CHOOSE_MALE).click();
        driver.findElement(UPLOAD_BUTTON).sendKeys("C:\\driver\\avatar.png");
